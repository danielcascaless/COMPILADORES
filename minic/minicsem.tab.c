...
{
  "$end", "error", "$undefined", "RVAR", "RCONST", "RINT", "RIF", "RELSE",
  "RWHILE", "RDO", "RFOR", "RPRINT", "RREAD", "SEMICOLON", "COMMA",
  "OPLUS", "OMINUS", "OASTERISK", "OSLASH", "OASSIGN", "OLESS", "OGREATER",
  "OLESSEQUAL", "OGREATEREQUAL", "OEQUALS", "ONOTEQUALS", "PARENL",
...
#line 103 "minicsem.y"
          { setup_program(); }
#line 1512 "minicsem.tab.c"
    break;

  case 3:
#line 103 "minicsem.y"
                                                                                       { generar_programa_base((yyvsp[-6].lex), (yyvsp[-2].code), (yyvsp[-1].code));  }
#line 1518 "minicsem.tab.c"
    break;

  case 4:
#line 106 "minicsem.y"
                                           { (yyval.code) = (yyvsp[-4].code); }
#line 1524 "minicsem.tab.c"
    break;

  case 5:
#line 107 "minicsem.y"
                                               { concatenaLC((yyvsp[-4].code), (yyvsp[-1].code)); (yyval.code) = (yyvsp[-4].code); comment((yyval.code)); }
#line 1530 "minicsem.tab.c"
    break;

  case 6:
#line 108 "minicsem.y"
        { (yyval.code) = creaLC(); }
#line 1536 "minicsem.tab.c"
    break;

  case 8:
#line 114 "minicsem.y"
              { symtable_push((yyvsp[0].lex)); agregar_variable_datos((yyvsp[0].lex)); }
#line 1542 "minicsem.tab.c"
    break;

  case 9:
#line 115 "minicsem.y"
                             { symtable_push((yyvsp[0].lex)); agregar_variable_datos((yyvsp[0].lex)); }
#line 1548 "minicsem.tab.c"
    break;

  case 10:
#line 118 "minicsem.y"
                             { symtable_push((yyvsp[-2].lex)); agregar_variable_datos((yyvsp[-2].lex)); (yyval.code) = generar_constantes(creaLC(), (yyvsp[-2].lex), (yyvsp[0].code)); }
#line 1554 "minicsem.tab.c"
    break;

  case 11:
#line 119 "minicsem.y"
                                              { symtable_push((yyvsp[-2].lex)); agregar_variable_datos((yyvsp[-2].lex)); (yyval.code) = generar_constantes((yyvsp[-4].code), (yyvsp[-2].lex), (yyvsp[0].code)); }
#line 1560 "minicsem.tab.c"
    break;

  case 12:
#line 122 "minicsem.y"
                                          { concatenaLC((yyvsp[-1].code), (yyvsp[0].code)); (yyval.code) = (yyvsp[-1].code); }
#line 1566 "minicsem.tab.c"
    break;

  case 13:
#line 123 "minicsem.y"
                 {(yyval.code) = creaLC();}
#line 1572 "minicsem.tab.c"
    break;

  case 14:
#line 126 "minicsem.y"
                                      { (yyval.code) = generar_asignacion((yyvsp[-3].lex), (yyvsp[-1].code)); }
#line 1578 "minicsem.tab.c"
    break;

  case 15:
#line 127 "minicsem.y"
                                             { (yyval.code) = (yyvsp[-1].code); }
#line 1584 "minicsem.tab.c"
    break;

  case 16:
#line 128 "minicsem.y"
                                                             { (yyval.code) = generar_if_else((yyvsp[-4].code), (yyvsp[-2].code), (yyvsp[0].code)); }
#line 1590 "minicsem.tab.c"
    break;

  case 17:
#line 129 "minicsem.y"
                                             { (yyval.code) = generar_if((yyvsp[-2].code), (yyvsp[0].code)); }
#line 1596 "minicsem.tab.c"
    break;

  case 18:
#line 130 "minicsem.y"
                                                { (yyval.code) = generar_bucle_while((yyvsp[-2].code), (yyvsp[0].code)); }
#line 1602 "minicsem.tab.c"
    break;

  case 19:
#line 131 "minicsem.y"
                                                              { (yyval.code) = generar_bucle_do_while((yyvsp[-5].code), (yyvsp[-2].code)); }
#line 1608 "minicsem.tab.c"
    break;

  case 20:
#line 132 "minicsem.y"
                                                                        { (yyval.code) = generar_bucle_for((yyvsp[-6].lex), (yyvsp[-4].lex), (yyvsp[-2].code), (yyvsp[0].code), 0, "1"); }
#line 1614 "minicsem.tab.c"
    break;

  case 21:
#line 133 "minicsem.y"
                                                                                              { (yyval.code) = generar_bucle_for((yyvsp[-9].lex), (yyvsp[-7].lex), (yyvsp[-5].code), (yyvsp[0].code), 1, (yyvsp[-2].lex)); }
#line 1620 "minicsem.tab.c"
    break;

  case 22:
#line 134 "minicsem.y"
                                                                                       { (yyval.code) = generar_bucle_for((yyvsp[-8].lex), (yyvsp[-6].lex), (yyvsp[-4].code), (yyvsp[0].code), 0, (yyvsp[-2].lex)); }
#line 1626 "minicsem.tab.c"
    break;

  case 23:
#line 135 "minicsem.y"
                                                      { (yyval.code) = (yyvsp[-2].code); comment((yyval.code)); }
#line 1632 "minicsem.tab.c"
    break;

  case 24:
#line 136 "minicsem.y"
                                                    { (yyval.code) = (yyvsp[-2].code); comment((yyval.code)); }
#line 1638 "minicsem.tab.c"
    break;

  case 25:
#line 139 "minicsem.y"
                        { (yyval.code) = (yyvsp[0].code); }
#line 1644 "minicsem.tab.c"
    break;

  case 26:
#line 140 "minicsem.y"
                                         { concatenaLC((yyvsp[-2].code), (yyvsp[0].code)); (yyval.code) = (yyvsp[-2].code); }
#line 1650 "minicsem.tab.c"
    break;

  case 27:
#line 143 "minicsem.y"
                  { (yyval.code) = generar_impresion_expresion((yyvsp[0].code)); }
#line 1656 "minicsem.tab.c"
    break;

  case 28:
#line 144 "minicsem.y"
                  { (yyval.code) = generar_impresion_cadena((yyvsp[0].lex)); }
#line 1662 "minicsem.tab.c"
    break;

  case 29:
#line 147 "minicsem.y"
               { (yyval.code) = generar_lectura((yyvsp[0].lex)); }
#line 1668 "minicsem.tab.c"
    break;

  case 30:
#line 148 "minicsem.y"
                               { concatenaLC((yyvsp[-2].code), generar_lectura((yyvsp[0].lex))); (yyval.code) = (yyvsp[-2].code); }
#line 1674 "minicsem.tab.c"
    break;

  case 31:
#line 151 "minicsem.y"
                       { (yyval.code) = generar_operacion_binaria("add", (yyvsp[-2].code), (yyvsp[0].code)); }
#line 1680 "minicsem.tab.c"
    break;

  case 32:
#line 152 "minicsem.y"
                        { (yyval.code) = generar_operacion_binaria("sub", (yyvsp[-2].code), (yyvsp[0].code)); }
#line 1686 "minicsem.tab.c"
    break;

  case 33:
#line 153 "minicsem.y"
                           { (yyval.code) = generar_operacion_binaria("mul", (yyvsp[-2].code), (yyvsp[0].code)); }
#line 1692 "minicsem.tab.c"
    break;

  case 34:
#line 154 "minicsem.y"
                        { (yyval.code) = generar_operacion_binaria("div", (yyvsp[-2].code), (yyvsp[0].code)); }
#line 1698 "minicsem.tab.c"
    break;

  case 35:
#line 155 "minicsem.y"
                       { (yyval.code) = generar_operacion_relacional("slt", (yyvsp[-2].code), (yyvsp[0].code)); }
#line 1704 "minicsem.tab.c"
    break;

  case 36:
#line 156 "minicsem.y"
                          { (yyval.code) = generar_operacion_relacional("sgt", (yyvsp[-2].code), (yyvsp[0].code)); }
#line 1710 "minicsem.tab.c"
    break;

  case 37:
#line 157 "minicsem.y"
                            { (yyval.code) = generar_operacion_relacional("sle", (yyvsp[-2].code), (yyvsp[0].code)); }
#line 1716 "minicsem.tab.c"
    break;

  case 38:
#line 158 "minicsem.y"
                               { (yyval.code) = generar_operacion_relacional("sge", (yyvsp[-2].code), (yyvsp[0].code)); }
#line 1722 "minicsem.tab.c"
    break;

  case 39:
#line 159 "minicsem.y"
                         { (yyval.code) = generar_operacion_relacional("seq", (yyvsp[-2].code), (yyvsp[0].code)); }
#line 1728 "minicsem.tab.c"
    break;

  case 40:
#line 160 "minicsem.y"
                            { (yyval.code) = generar_operacion_relacional("sne", (yyvsp[-2].code), (yyvsp[0].code)); }
#line 1734 "minicsem.tab.c"
    break;

  case 41:
#line 161 "minicsem.y"
                                                       { (yyval.code) = generar_operador_condicional((yyvsp[-5].code), (yyvsp[-3].code), (yyvsp[-1].code)); }
#line 1740 "minicsem.tab.c"
    break;

  case 42:
#line 162 "minicsem.y"
                                 { (yyval.code) = generar_negacion((yyvsp[0].code)); }
#line 1746 "minicsem.tab.c"
    break;

  case 43:
#line 163 "minicsem.y"
                          { (yyval.code) = (yyvsp[-1].code); }
#line 1752 "minicsem.tab.c"
    break;

  case 44:
#line 164 "minicsem.y"
          { (yyval.code) = generar_carga_identificador((yyvsp[0].lex)); }
#line 1758 "minicsem.tab.c"
    break;

  case 45:
#line 165 "minicsem.y"
            { (yyval.code) = generar_literal_entero((yyvsp[0].lex)); }
#line 1764 "minicsem.tab.c"
    break;


#line 1768 "minicsem.tab.c"
